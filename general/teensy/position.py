...
def sendRobotPos():
    ...
    sendPos = (f"A{JangleIn[0]:.3f}B{JangleIn[1]:.3f}C{JangleIn[2]:.3f}D{JangleIn[3]:.3f}"
...
def correctRobotPos():
    ...
    sendPos = "A" + str(round(JangleIn[0], 3)) + "B" + str(round(JangleIn[1], 3)) + "C" + str(round(JangleIn[2], 3)) + "D" + str(round(JangleIn[3], 3)) + "E" + str(round(JangleIn[4], 3)) + "F" + str(round(JangleIn[5], 3)) + "G" + str(round(xyzuvw_Out[0], 3)) + "H" + str(round(xyzuvw_Out[1], 3)) + "I" + str(round(xyzuvw_Out[2], 3)) + "J" + str(round(xyzuvw_Out[3], 3)) + "K" + str(round(xyzuvw_Out[4], 3)) + "L" + str(round(xyzuvw_Out[5], 3)) + "M" + speedViolation + "N" + debug + "O" + flag + "P" + J7_pos + "Q" + J8_pos + "R" + J9_pos
    np.delay(5)
    print(sendPos)
    speedViolation = "0"
    flag = ""
